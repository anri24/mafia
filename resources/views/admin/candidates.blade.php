    ...
    <div style="margin-left: 5%" >
        <div class="container px-4 text-center">
            <div class="row gx-5">
                <div class="col">
                    <div class="p-3">
                        <a style="margin-left: auto" href="{{ route('admin.table.players',$table->id) }}"><button type="button" class="btn btn-success">მოთამაშეების სია</button></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <table class="table" style="width: 90%" align="center">
        ...
        @foreach($candidates as $candidate)
            ...
            <tr>
                ...
                <td>@if(isset($candidate->members->role)){{ $candidate->members->role->name }} @endif</td>
